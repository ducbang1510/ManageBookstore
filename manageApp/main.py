...
def my_account():
    ...
    if current_user.is_authenticated:
        return render_template("my-account.html", categories=categories, cart_info=cart_info)
    return redirect(url_for('index'))
...
#Xóa giỏ hàng
@app.route("/api/cart/<int:b_id>", methods=["delete"])
...
def shop_cart():
    ...
    return render_template('shop_cart.html', categories=categories,
                           cart_info=cart_info)
